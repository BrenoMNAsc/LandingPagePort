    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          color: const Color.fromRGBO(225, 187, 201, 1),
        ),
        ...
        height: ResponsiveWidget.isMediumScreen(context) ||
                ResponsiveWidget.isLargeScreen(context) ? MediaQuery.of(context).size.height * 0.4: null,
                            ...
                            Container(
                              ...
                              child: Text(
                                  ...
                                  style: GoogleFonts.poppins(
                                      ...
                                      color:
                                          const Color.fromRGBO(27, 31, 59, 1))),
                            ),
                            Container(                  width: ResponsiveWidget.isLargeScreen(context)
                                  ? MediaQuery.of(context).size.width * 0.225
                                  : MediaQuery.of(context).size.width * 0.5,
                              child: Text(desc,
